...
<template>
  <div>
    <div class="mt-5 w-full bg-white py-12 px-7 rounded-2xl text-white">
      <h1 class="text-center font-medium text-black text-2xl tracking-tight">Proporsi Pendanaan Per Tingkatan Pemerintah Daerah</h1>
      ...
      <div class="flex flex-col gap-8 w-full mt-10 px-4">
