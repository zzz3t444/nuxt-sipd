  ...
  <div class="inter">
    <div class="group z-[1000]">
      <div
        ...
        <a href="#" class="text-neutral-600 block md:hidden" id="small-bar">
      ...
      <div class="sidebar smoll fixed transition-all -left-[225px] md:left-0 top-[70px] h-screen max-h-screen w-[225px] md:w-[70px] bg-white z-40 flex flex-col md:group-hover:w-[225px] shadow-xl">
        <ul class="flex flex-col gap-5 py-5 overflow-y-auto no-scrollbar">
          <li class="px-5">
            <div class="text-neutral-600 block md:hidden text-nowrap font-medium uppercase group-hover:block">Menu Utama</div>
            <div class="text-neutral-600 hidden md:block text-center small-cap md:group-hover:hidden">...</div>
          </li>
          <li class="px-5">
            <div>
              <div class="text-neutral-600 font-bold text-center icon float-left md:float-none md:group-hover:float-left">
                <i class="fas fa-th-large"></i>
              </div>
              <NuxtLink class="text-neutral-600 pl-3 block md:hidden text-nowrap cap text-ellipsis overflow-hidden md:group-hover:block" to="/"> Dashboard </NuxtLink>
            </div>
          </li>
          <li class="px-5">
            <div>
              <div class="text-neutral-600 font-bold text-center icon md:float-none float-left md:group-hover:float-left">
                <i class="fa-solid fa-folder"></i>
              </div>
              <NuxtLink class="text-neutral-600 pl-3 block md:hidden text-nowrap cap text-ellipsis overflow-hidden md:group-hover:block" to="/rekap"> Rekap </NuxtLink>
            </div>
          </li>
          <li class="px-5 hidden-list" id="hidden-list">
            <a href="#" class="collappse flex items-center md:block md:group-hover:flex md:group-hover:items-center" @click.prevent="togglePembangunanSubmenu">
              <div class="text-neutral-600 text-center icon float-left md:float-none md:group-hover:float-left">
                <i class="fa-solid fa-circle-info"></i>
              </div>
              <div class="text-neutral-600 pl-3 block md:hidden text-nowrap cap text-ellipsis overflow-hidden md:group-hover:block">Informasi Pembangunan</div>
              <i class="fa-solid fa-chevron-left block md:hidden cap text-neutral-600 ml-2 arrow transition-all md:group-hover:block" :class="{ '-rotate-90': isPembangunanSubmenuOpen }"> </i>
            </a>
            <ul v-show="isPembangunanSubmenuOpen" class="flex flex-col gap-5 py-7">
              <li class="">
                <NuxtLink to="/tematik">
                  <div class="text-neutral-600 block md:hidden text-nowrap cap px-7 md:group-hover:block">Tematik</div>
                  <div class="text-neutral-600 text-center hidden md:block small-cap md:group-hover:hidden">
              ...
              <li class="">
                <NuxtLink to="/bidang_urusan">
                  <div class="text-neutral-600 block md:hidden text-nowrap cap px-7 md:group-hover:block">Bidang Urusan</div>
                  <div class="text-neutral-600 text-center hidden md:block small-cap md:group-hover:hidden">
                    <i class="fa-solid fa-tag"></i>
                  </div>
                </NuxtLink>
              ...
              <li class="">
                <NuxtLink to="/sumber_pendanaan">
                  <div class="text-neutral-600 block md:hidden text-nowrap cap px-7 md:group-hover:block">Sumber Pendanaan</div>
                  <div class="text-neutral-600 text-center hidden md:block small-cap md:group-hover:hidden">
          ...
          <li class="px-5">
            <div class="text-neutral-600 block md:hidden text-nowrap font-medium uppercase md:group-hover:block">Provinsi</div>
            <div class="text-neutral-600 hidden md:block text-center small-cap md:group-hover:hidden">...</div>
          </li>
          <li class="px-5 hidden-list">
            <a
              ...
              <div
                class="text-neutral-600 text-center icon float-left md:float-none md:group-hover:float-left flex items-center md:block md:group-hover:flex md:group-hover:items-center collapse-title">
                <i class="fa-solid fa-location-pin"></i>
                <div class="text-neutral-600 pl-3 block md:hidden text-nowrap cap text-ellipsis overflow-hidden md:group-hover:block">ACEH</div>
              </div>
              <i class="fa-solid fa-chevron-left block md:hidden cap text-neutral-600 ml-2 arrow transition-all md:group-hover:block" :class="{ '-rotate-90': isProvinceSubmenuOpen }"></i>
            </a>
            <ul v-show="isProvinceSubmenuOpen" class="flex flex-col gap-5 py-7">
              <li class="">
                <NuxtLink to="/dashboard/aceh">
                  <div class="text-neutral-600 block md:hidden text-nowrap cap px-7 md:group-hover:block">Data Provinsi</div>
              ...
              <li class="hidden-list" id="hidden-list">
                <a
                  ...
                  <div
                    class="text-neutral-600 text-center icon float-left md:float-none md:group-hover:float-left flex items-center md:block md:group-hover:flex md:group-hover:items-center collapse-title">
                    <div class="text-neutral-600 px-2 block md:hidden text-nowrap cap text-ellipsis overflow-hidden md:group-hover:block">Data Per Kab/Kota</div>
                  </div>

                  <i class="fa-solid fa-chevron-left block md:hidden cap text-neutral-600 ml-2 arrow transition-all md:group-hover:block" :class="{ '-rotate-90': isKabKotaSubmenuOpen }"></i>
                </a>
                <div class="text-neutral-600 hidden md:block text-center small-cap md:group-hover:hidden">
                  <i class="fa-solid fa-tag"></i>
                </div>
    ...
    <div
      ...
      <div class="flex justify-between items-center px-5">
        <a href="#" class="text-neutral-200 absolute z-50" id="bars">
          <i class="fa-solid fa-bars"></i>
        </a>
      </div>
    </div>
