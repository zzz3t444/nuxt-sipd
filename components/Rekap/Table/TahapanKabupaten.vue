...
const filteredData = computed(() => {
  ...
  return props.data.filter(
    (item) =>
      ...
      item.tahapan.penetapan_kua_dan_ppas.toString().includes(searchTerm.value) ||
      item.tahapan.rancangan.toString().includes(searchTerm.value) ||
      item.tahapan.rancangan_apbd.toString().includes(searchTerm.value) ||
      item.tahapan.rancangan_kua_dan_ppas.toString().includes(searchTerm.value) ||
      ...
      <table class="w-full border-collapse border border-gray-300">
        <thead>
          <tr class="grid grid-rows-2 grid-cols-12">
            <th class="row-span-2 col-span-1 border border-gray-300 p-2">Kode</th>
            <th class="row-span-2 col-span-1 border border-gray-300 p-2">Provinsi</th>
            <th class="row-span-1 col-span-10 border border-gray-300 p-2">Jumlah Rekap Tahapan di Kab/Kota Per-Provinsi</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Belum Input</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Rancangan Awal</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Rancangan</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Musrenbang</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Rancangan Akhir</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Penetapan</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Rancangan KUA dan PPAS</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Penetapan KUA dan PPAS</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Rancangan APBD</th>
            <th class="row-span-1 col-span-1 border border-gray-300 p-2">Penetapan APBD</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(item, index) in filteredData" :key="index" class="grid grid-cols-12">
