<template>
  <div>
    ...
    <div v-if="$route.params.district === 'rekap'">
      ...
      <div
        v-show="showModal"
        class="absolute top-0 inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[500] py-[10px] overflow-auto"
      >
    ...
    <div v-else>
      <div class="w-full bg-white mt-6 rounded">
        ...
        <div class="flex flex-row p-10 items-center">
          <img
            class="w-28 h-28 mr-10"
            src="@/assets/images/aceh.png"
            alt="logo"
          />
          <div class="flex flex-col w-full">
            <div class="border-b-2 pb-5">
              ...
              <h1>
                PERIODE RPJMD (2018 - 2023) - "Terwujudnya Aceh Selatan yang
                Bekeadilan Secara Sosial dan Ekonomi"
              </h1>
            </div>
